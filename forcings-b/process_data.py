...
RANGE = (-1, 2)
FORCING_HEADERS = [
    {"name": "Orbital changes", "className": "natural", "label": "Earth's orbital changes", "title": "Is it the Earth's orbit?", "sub": "The Earth wobbles as it takes its yearly trips around the sun, changing the way sunlight reaches the planet’s surface. In the past, these shifts brought us in an out of ice ages—but the effect over the last 125 years is small."},
    ...
    {"name": "Volcanic", "className": "natural", "label": "Volcanic activity", "title": "Is it volcanoes?", "sub": "Erupting volcanoes throw a layer of ash, dust, and chemicals into the air. This mix includes both greenhouse gases, which warm the planet, and aerosols, which can cool it for a short time. Humans emit about 100 times more greenhouse gases than volcanoes."},
    ...
    {"name": "Land use", "className": "human", "label": "Deforestation", "title": "Is it deforestation?", "sub": "When forests are cleared to make room for industry, farming, and growing cities, the land underneath reflects more sunlight than the darker trees. Since more of this light bounces off the Earth’s surface, losing our forests can cause our planet to cool a little."},
    ...
    {"name": "Greenhouse gases", "className": "human", "label": "Greenhouse gases", "title": "Is it greenhouse gases?", "sub": "The rise in heat-trapping greenhouse gases is the only factor that matches the world’s warming since 1880. In just a few hundred years, human activity has pushed the amount of carbon present in our atmosphere to their highest levels in 4 million years."},
